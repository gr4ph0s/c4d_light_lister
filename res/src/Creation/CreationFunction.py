            ...
            for i in xrange(len(lights_list)):
                if dialog.GroupBegin(ui_id_grp + i + 2, c4d.BFH_SCALEFIT | c4d.BFV_TOP, 1, 2, "", c4d.BFV_GRIDGROUP_EQUALROWS):
                    ...
                    if self.__is_first(i, lights_list):
                        ...
                        path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'up.png')
                    ...
                    if not self.__is_last(i, lights_list):
                        path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'down.png')
